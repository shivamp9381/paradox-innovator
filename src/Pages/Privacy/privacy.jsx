...
//             <Footer />
//         </div>  // ← This is closing only the inner div but not the outermost div
//         </div>  // ← This is closing the outer div
    ...
    return (
        <div>
            ...
            <div className={styles.pageContainer}>
                ...
                <div style={{ background: 'transparent' }}>
                    <h1 style={{ fontFamily: 'Arial', fontSize: '26px', color: '#000000' }}>
                        PRIVACY POLICY
                    </h1>
                    <div style={{ color: '#7F7F7F', fontSize: '15px' }}>
                        <strong>Last updated January 23, 2025</strong>
                    ...
                    <div style={{ lineHeight: '1.5', color: '#595959', fontSize: '15px' }}>
                        ...
                        <ul>
                            <li>
                                ...
                                <a href="https://paradox-innovator.vercel.app/" 
                                    target="_blank" 
                                    style={{ color: '#003AF1' }}>
                                    https://paradox-innovator.vercel.app/
                                </a>, 
                        ...
                        <p>
                            ...
                            If you still have any questions or concerns, please contact us at info.paradoxinnovator@gmail.com.
                        </p>
                    </div>
                    <h2 style={{ fontFamily: 'Arial', fontSize: '19px', color: '#000000' }}>
